...
export class TeamQueueCredits1784380627920 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "teams" DROP COLUMN "inQueue"`);
    ...
    await queryRunner.query(
      `ALTER TABLE "matches" ADD CONSTRAINT "FK_532f48f0b764a6bea4801d3829d" FOREIGN KEY ("creditWagerTeamId") REFERENCES "teams"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "matches" DROP CONSTRAINT "FK_532f48f0b764a6bea4801d3829d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "teams" ADD "inQueue" boolean NOT NULL DEFAULT false`,
    );
  }
}
