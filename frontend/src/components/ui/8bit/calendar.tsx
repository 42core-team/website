...
import { Calendar as ShadcnCalendar } from '#/components/ui/calendar.tsx'
      ...
      <ShadcnCalendar
        ...
        components={{
          MonthsDropdown: ({
            ...
            const currentMonth = dropdownProps.value as number
          ...
          YearsDropdown: ({ className: dropdownClassName }) => {
