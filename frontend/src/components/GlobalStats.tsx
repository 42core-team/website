...
export default function GlobalStats() {
  ...
  const statCards = [
    {
      title: "Total Damage",
      value: Number.parseInt(statsQuery.data?.damageTotal || "0"),
      icon: Flame,
    ...
    {
      title: "Gems Gained",
      value: Number.parseInt(statsQuery.data?.gemsGained || "0"),
      icon: Gem,
    ...
    {
      title: "Units Spawned",
      value: Number.parseInt(statsQuery.data?.unitsSpawned || "0"),
      icon: User,
