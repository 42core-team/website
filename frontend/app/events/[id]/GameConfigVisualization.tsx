                    ...
                    <CardContent className="p-6 flex flex-col items-center justify-center min-h-[400px] gap-6">
                        ...
                        >
                            {config.corePositions.map((pos, i) => (
                                <div
                                    key={i}
                                    className="bg-primary rounded-full shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                                    style={{
                    ...
                    <CardContent className="p-6 overflow-auto">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="font-mono text-white">{config.idleIncome} (until {config.idleIncomeTimeOut})</span>
                            </div>
                            <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-3">
                            {config.units.map((u, i) => (
                                <div key={i} className="flex items-center justify-between text-sm">
                                    ...
                                    <span className="bg-white/5 px-2 py-0.5 rounded text-xs text-muted-foreground">
                                        Build: <span className="text-white">{u.buildType}</span>
                                    </span>
                                </div>
                            ))}
                        </div>
