...
export const DiscordIcon1: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const TwitterIcon1: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const GithubIcon1: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const LinkedinIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5ZM.5 8h4v15h-4V8Zm7.5 0h3.84v2.05h.05c.53-1.01 1.84-2.08 3.79-2.08 4.05 0 4.8 2.67 4.8 6.14V23h-4v-7.88c0-1.88-.03-4.3-2.62-4.3-2.63 0-3.03 2.05-3.03 4.16V23h-4V8Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const DiscordIcon2: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const TwitterIcon2: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const CoreLogoWhite: React.FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
...
export const DiscordIcon = DiscordIcon1;
export const TwitterIcon = TwitterIcon1;
export const GithubIcon = GithubIcon1;
